...
const messageInboundPayloadSchema = baseWebhookPayloadSchema.extend({
  ...
  message_type: z
    .enum(["text", "reaction", "audio", "attachments", "sticker", "location"])
    .optional(),
...
export const loopMessageWebhookPayloadSchema = z.discriminatedUnion(
  "alert_type",
  [
...
export type LoopMessageSendRequest = z.infer<
  typeof loopMessageSendRequestSchema
>;
export type LoopMessageSendResponse = z.infer<
  typeof loopMessageSendResponseSchema
>;
export type LoopMessageError = z.infer<typeof loopMessageErrorSchema>;
export type LoopMessageWebhookPayload = z.infer<
  typeof loopMessageWebhookPayloadSchema
>;
export type LoopMessageInboundPayload = z.infer<
  typeof messageInboundPayloadSchema
>;
